...
const query = {
  ...
  variables: { version: 7, period: 7, first: 13, after: 'YXJyYXljb25uZWN0aW9uOjEy', loggedIn: false, unreadOnly: false },
};

export default class DailyDevStoryService extends StoryService {
  constructor(private currentCursor: string) {
    super('https://app.daily.dev/api/graphql', new DailyDevStoryParser(), null, null);
  }
